...
/**
 * 
 * Informações de identificação do ambiente de trabalho do empregador e de
 * validade das informações.
 *
 */
public class IdeAmbiente {
	...
	/**
	 * Preencher com o código atribuído pela empresa ao Ambiente de Trabalho</br>
	 * </br>
	 ...
	 * @return
	 */
	public IdeAmbiente setCodAmb(String codAmb) {
		this.codAmb = codAmb;
		return this;
	}
	 ...
	 * @return IdeAmbiente
	 */
	public IdeAmbiente setIniValid(String iniValid) {
	 ...
	 * @return IdeAmbiente
	 */
	public IdeAmbiente setFimValid(String fimValid) {
	...
	public boolean equals(final Object other) {
		if (!(other instanceof IdeAmbiente)) {
			return false;
		}
		IdeAmbiente castOther = (IdeAmbiente) other;
		return new EqualsBuilder()
				.append(codAmb, castOther.codAmb)
