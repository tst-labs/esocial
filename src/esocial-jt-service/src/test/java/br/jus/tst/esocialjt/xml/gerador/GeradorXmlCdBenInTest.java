...
@SpringBootTest
public class GeradorXmlCdBenInTest {
	
	@Autowired
	GeradorXmlCdBenIn gerador;
	...
	public void deveGerarXmlCdBenefIn() throws Exception {
		...
		assertThat(xml).contains("evtCdBenIn");
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.CADASTRO_BENEFICIO_INI);
		...
		evento.setTipoEvento(TipoEvento.CADASTRO_BENEFICIO_INI);
