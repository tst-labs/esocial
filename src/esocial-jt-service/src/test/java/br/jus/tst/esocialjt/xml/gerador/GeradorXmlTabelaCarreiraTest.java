...
@SpringBootTest
public class GeradorXmlTabelaCarreiraTest {

	@Autowired
	GeradorXmlTabelaCarreira gerador;
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.TABELA_CARREIRA);
		...
		evento.setTipoEvento(TipoEvento.TABELA_CARREIRA);
