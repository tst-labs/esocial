...
class Processador2231Test {

    @Test
    public void deveProcessar2231SobreEmpregadoExistente(){
        ArrayList<RetEmpregado> listaRetEmpregado = new ArrayList<>();
        Empregado inicial = OcorrenciaUtil.lerEmpregado("ret/empregado/s2231/inicial.json");
        RetEmpregado retEmpregado = new RetEmpregado();
        retEmpregado.empregado = inicial;
        listaRetEmpregado.add(retEmpregado);

        Ocorrencia ocorrencia = OcorrenciaUtil.lerOcorrencia("ret/empregado/s2231/cessao.json");
        Empregado esperado = OcorrenciaUtil.lerEmpregado("ret/empregado/s2231/esperado.json");

        Processador2231 processador = new Processador2231();
    ...
    @Test
    public void deveProcessar2231SomenteMatriculaIgual() {
        Empregado inicial1 = OcorrenciaUtil.lerEmpregado("ret/empregado/s2231/inicial.json");
        RetEmpregado retEmpregado1 = new RetEmpregado();
        retEmpregado1.empregado = inicial1;

        Empregado inicial2 = OcorrenciaUtil.lerEmpregado("ret/empregado/s2231/inicial.json");
        ...
        Ocorrencia ocorrencia = OcorrenciaUtil.lerOcorrencia("ret/empregado/s2231/cessao.json");
        Empregado esperado1 = OcorrenciaUtil.lerEmpregado("ret/empregado/s2231/esperado.json");
        Empregado esperado2 = OcorrenciaUtil.lerEmpregado("ret/empregado/s2231/inicial.json");
