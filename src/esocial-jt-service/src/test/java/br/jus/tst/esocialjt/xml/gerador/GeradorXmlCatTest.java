...
@SpringBootTest
public class GeradorXmlCatTest {
	
	@Autowired
	GeradorXmlCat gerador;
	...
	public void deveGerarXmlExpRisco() throws Exception {
		...
		assertThat(xml).contains("evtCAT");
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.CAT);
		...
		evento.setTipoEvento(TipoEvento.CAT);
