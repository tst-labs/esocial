...
@SpringBootTest
public class GeradorXmlTabelaCargoTest {
	
	@Autowired
	GeradorXmlTabelaCargo gerador;
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.TABELA_CARGO);
		...
		evento.setTipoEvento(TipoEvento.TABELA_CARGO);
