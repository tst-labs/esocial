...
@SpringBootTest
public class GeradorXmlTabelaEstabelecimentoTest {

	@Autowired
	GeradorXmlTabelaEstabelecimento gerador;
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.TABELA_ESTABELECIMENTO);
		...
		evento.setTipoEvento(TipoEvento.TABELA_ESTABELECIMENTO);
