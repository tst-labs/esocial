...
class Processador2230Test {

    @Test
    public void deveProcessar2230SobreEmpregadoExistente(){
        ArrayList<RetEmpregado> listaRetEmpregado = new ArrayList<>();
        Empregado inicial = OcorrenciaUtil.lerEmpregado("ret/empregado/s2230/inicial.json");
        RetEmpregado retEmpregado = new RetEmpregado();
        retEmpregado.empregado = inicial;
        listaRetEmpregado.add(retEmpregado);

        Ocorrencia ocorrencia = OcorrenciaUtil.lerOcorrencia("ret/empregado/s2230/afastamento_temporario.json");
        Empregado esperado = OcorrenciaUtil.lerEmpregado("ret/empregado/s2230/esperado.json");

        Processador2230 processador = new Processador2230();
    ...
    @Test
    public void deveProcessar2230SomenteMatriculaIgual() {
        Empregado inicial1 = OcorrenciaUtil.lerEmpregado("ret/empregado/s2230/inicial.json");
        RetEmpregado retEmpregado1 = new RetEmpregado();
        retEmpregado1.empregado = inicial1;

        Empregado inicial2 = OcorrenciaUtil.lerEmpregado("ret/empregado/s2230/inicial.json");
        ...
        Ocorrencia ocorrencia = OcorrenciaUtil.lerOcorrencia("ret/empregado/s2230/afastamento_temporario.json");
        Empregado esperado1 = OcorrenciaUtil.lerEmpregado("ret/empregado/s2230/esperado.json");
        Empregado esperado2 = OcorrenciaUtil.lerEmpregado("ret/empregado/s2230/inicial.json");
