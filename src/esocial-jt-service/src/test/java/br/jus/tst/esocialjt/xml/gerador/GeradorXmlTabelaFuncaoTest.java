...
@SpringBootTest
public class GeradorXmlTabelaFuncaoTest {

	@Autowired
	GeradorXmlTabelaFuncao gerador;
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.TABELA_FUNCAO);
		...
		evento.setTipoEvento(TipoEvento.TABELA_FUNCAO);
