...
@SpringBootTest
public class GeradorXmlTabelaHorarioTest {

	@Autowired
	GeradorXmlTabelaHorario gerador;
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.TABELA_HORARIO);
		...
		evento.setTipoEvento(TipoEvento.TABELA_HORARIO);
