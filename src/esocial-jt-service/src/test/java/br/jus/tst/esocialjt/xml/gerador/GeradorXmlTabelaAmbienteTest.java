...
@SpringBootTest
public class GeradorXmlTabelaAmbienteTest {
	
	@Autowired
	GeradorXmlTabelaAmbiente gerador;
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.TABELA_AMBIENTE);
		...
		evento.setTipoEvento(TipoEvento.TABELA_AMBIENTE);
