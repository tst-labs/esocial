...
@SpringBootTest
public class GeradorXmlTabelaRubricaTest {

	@Autowired
	GeradorXmlTabelaRubrica gerador;
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.TABELA_RUBRICA);
		...
		evento.setTipoEvento(TipoEvento.TABELA_RUBRICA);
