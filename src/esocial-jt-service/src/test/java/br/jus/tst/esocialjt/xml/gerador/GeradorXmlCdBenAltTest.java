...
@SpringBootTest
public class GeradorXmlCdBenAltTest {
	
	@Autowired
	GeradorXmlCdBenAlt gerador;
	...
	public void deveGerarXmlCdBenefIn() throws Exception {
		...
		assertThat(xml).contains("evtCdBenAlt");
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.CADASTRO_BENEFICIO_ALT);
		...
		evento.setTipoEvento(TipoEvento.CADASTRO_BENEFICIO_ALT);
