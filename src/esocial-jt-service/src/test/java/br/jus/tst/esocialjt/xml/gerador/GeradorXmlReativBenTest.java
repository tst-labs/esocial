...
@SpringBootTest
public class GeradorXmlReativBenTest {
	
	@Autowired
	GeradorXmlReativBen gerador;
	...
	public void deveGerarXmlCdBenefIn() throws Exception {
		...
		assertThat(xml).contains("evtReativBen");
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.REATIVACAO_BENEFICIO);
		...
		evento.setTipoEvento(TipoEvento.REATIVACAO_BENEFICIO);
