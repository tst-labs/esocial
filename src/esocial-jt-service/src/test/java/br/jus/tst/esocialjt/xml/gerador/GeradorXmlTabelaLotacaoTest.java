...
@SpringBootTest
public class GeradorXmlTabelaLotacaoTest {

	@Autowired
	GeradorXmlTabelaLotacao gerador;
	...
	private Evento getEvento() throws Exception {
		...
		Ocorrencia ocorrencia = exemplo.lerOcorrencia(TipoOcorrencia.TABELA_LOTACAO);
		...
		evento.setTipoEvento(TipoEvento.TABELA_LOTACAO);
