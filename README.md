...
Os scripts de criação do banco ficam localizados em [src/esocial-jt-service/main/resources/db/migration/](src/esocial-jt-service/main/resources/db/migration/). Os scripts podem ser executados de forma manual, porém utilizamos o [flyway](https://flywaydb.org/) para automatizar esse processo.
